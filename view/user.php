      ...
      <div class="modal-content">
        ...
        <div class="modal-body pl-5 pr-5">
            <form>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="width: 150px;">Birthday</span>
                    </div>
                    <input type="date" class="form-control" id="birthday" placeholder="2000-12-13">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
        ...
        <div class="modal-body pl-5 pr-5">
            <form>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" id="edit-birthday" placeholder="2000-12-13">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="width: 150px;">Username</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create-btn').click(function() {
                ...
                let role = $('#role').val();
                if(!name | !birthday | !username) alert('Please input all information!');
                else {
                    $.ajax({
                        ...
                        success:function(data) {
                            if(data == 'error1') alert('Username is already taken!');
                                ...
                                t.row.add([t.rows().count() + 1, name, birthday, username, roleName, "<button class='btn btn-success' id='edit-" + data + "'> <i class='fa fa-pencil-alt'></i> </button>", "<button class='btn btn-danger' id='delete-" + data + "'> <i class='fa fa-trash-alt'></i> </button>"]).draw(false);
                    ...
                    $.ajax({
                        ...
                        success:function(data) {
                            ...
                            if(data == 'error1') alert('Username is already taken!');
                                ...
                                let newData = [$('#edit-index').val(), name, birthday, username, roleName, "<button class='btn btn-success' id='edit-" + data + "'> <i class='fa fa-pencil-alt'></i> </button>", "<button class='btn btn-danger' id='delete-" + data + "'> <i class='fa fa-trash-alt'></i> </button>"];
