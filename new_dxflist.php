    ...
    <?php
        ...
        if(!empty($_POST['code']) && !empty($_FILES['input_XLSX']) ) {
            ...
            else
            {
                ...
                mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version);
                mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_GERBER');
                mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_PICTURE');
                mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_HARD_PRJ');
                mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_FIRM_PRJ');
                // mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_FIRM_PRJ'.'/'.$code.'_'.$version.'_FIRM_SRC');
                // mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_FIRM_PRJ'.'/'.$code.'_'.$version.'_FIRM_CMP');
                mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_FIRM_TP');
                // mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_FIRM_TP'.'/'.$code.'_'.$version.'_FIRM_HWP');
                // mkdir('public/'.$code.'_'.$version.'/'.$code.'_'.$version.'_FIRM_TP'.'/'.$code.'_'.$version.'_FIRM_FWP');
                $moduleName = $row['id'];
